    ...
    get: async (req: express.Request, res: express.Response) => {
        try {
            ...
            if(queryPokemon1 && queryPokemon2){
                ...
                res.render('vergelijken', {user: user, pokemon1FromApi: pokemon1Updated, pokemon2FromApi: pokemon2Updated});
                ...
                res.render('vergelijken', {user: user, pokemon1FromApi: pokemon1Updated});

            }else{
                res.render('vergelijken', { user: user, invalidPokemon });
            }
